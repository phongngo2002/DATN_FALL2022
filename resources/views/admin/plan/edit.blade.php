        ...
        <div class="row shadow p-3 mb-5 bg-white rounded ">
            <div class="col-12 col-lg-6">
                ...
                <div class="body m-2 p-2">
                    <input type="text" name="name" id="name" class="form-control" placeholder="nhập tên của gói dịch vụ" value="{{ $plan->name }}">
                </div>
                {{-- input name plans  --}}
                ...
                <div class="body m-2 p-2">
                    <input name="price" type="text" id="price" class="form-control" placeholder="Nhập giá của gói dịch vụ" value="{{ $plan->price }}">
                </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="">
                    ...
                    <div class="body m-2 p-2">
                        <input type="text" name="time" class="form-control" id="time" placeholder="nhập thời hạn của gói dịch vụ" value="{{ $plan->time }}">
                    </div>
                    {{-- input time plans  --}}
