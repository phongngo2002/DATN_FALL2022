...
@section('content')
  <div class="bg-white shadow-lg p-4 rounded-4">
      <a href="{{route('backend_admin_create_plans')}}" class="btn btn-primary my-2"><i class="fa-solid fa-folder-plus"></i>  Thêm mới</a>
      <table class="table text-center">
          ...
          @foreach($plans as $plan)
              <tr>
                  ...
                  <td>
                      <a href="{{route('backend_admin_edit_plans',['id' => $plan->id])}}" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
