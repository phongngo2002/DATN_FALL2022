                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                                <input type="text" name="email" class="form-control" placeholder="Paypal email">
                                <input type="number" class="form-control my-4" name="money" placeholder="Số tiền muốn rút">
                                <input type="text" class="form-control mt-4" name="code" placeholder="Mã xác minh">
                                <span><button type="button" id="buttonCode" class="btn btn-link text-sm">Lấy mã xác minh</button></span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="d-flex justify-content-between p-3">
                    ...
                    <div class="mt-1">
                        ...
                        <span class=""><i class="fa-brands fa-bitcoin text-warning"></i></span>
                    </div>
                ...
                <div class="p-3">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <span> 24.855 <i class="fa-brands fa-bitcoin text-warning"></i> = 1 $</span>
