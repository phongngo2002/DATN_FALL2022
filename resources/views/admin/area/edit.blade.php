            ...
            <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" name="latitude" value="{{$area->latitude}}" id="latitude" placeholder="Vĩ độ">
                    </div>
                    <div class="col-6">
                        <label for="">Longitude</label>
                        <input type="text" class="form-control" name="longitude" value="{{$area->longitude}}" id="longitude" placeholder="Kinh độ">
                    </div>
                </div>
                <div class="my-2">
...
<script>
    $("#content").validate({
        ...
        messages: {
            ...
            "district_id": {
                required: "Lựa chọn huyện",
            },
            "ward_id": {
                required: "Lựa chọn xã, phường"
            },
            "latitude": {
                required: "Nhập Vĩ độ",
            },
