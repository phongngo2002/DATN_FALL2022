            ...
            <div class="col-8">
                ...
                <div class="my-2 row">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" name="latitude" id="latitude" placeholder="Vĩ độ">
                    </div>
                    <div class="col-6">
                        <label for="">Longitude</label>
                        <input type="text" class="form-control" name="longitude" id="longitude" placeholder="Kinh độ">
                    </div>
                </div>
                <div class="my-2">
