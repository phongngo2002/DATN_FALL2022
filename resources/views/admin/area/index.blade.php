        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#exampleModal{{$area->id}}" class="btn btn-danger" title="Gửi hóa đơn tiên phòng"><i class="fa-solid fa-paper-plane"></i></button>
                    <div class="modal fade" id="exampleModal{{$area->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <form action="{{route('backend_send_bill')}}" method="POST" enctype="multipart/form-data" id="content">
