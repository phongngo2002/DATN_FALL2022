...
<form id="plans_form" action="{{route('saveEdit_role')}}" method="POST">
    ...
    <div class="bg-white shadow-lg rounded-4 p-4">
        ...
        <div class="body m-2 p-2">
            <input type="text" name="name" id="name" class="form-control" placeholder="Nhập tên của quyền" value="{{ old('name') ?? $key->name }}">
        </div>
        {{-- input name roles  --}}
        {{-- ////// --}}
        ...
        <div class="m-2">
            <input id="selectAll" class="form-check-input " type="checkbox">&nbsp; <label class="form-check-label" for='selectAll'> Chọn tất
                cả</label>
        </div>
    ...
    <button type="submit" class="btn btn-primary my-2" onclick="onHandleAddNew()"> Lưu </button>
