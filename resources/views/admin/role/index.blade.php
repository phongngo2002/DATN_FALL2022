...
@section('content')
    ...
    <div class="bg-white shadow-lg p-4 rounded-4">
        <a class="btn btn-primary my-2 text-white ms-2" href="{{ route('create_role') }}"><i
            ...
            @foreach ($Role as $item)
                <tr>
                    ...
                    <td class="d-none d-md-table-cell" colspan="2">
                        <a class="btn btn-warning" href="{{route('edit_role',$item->id)}}"><i
                                class="fa-solid fa-pen-to-square"></i></a>
                        <a class="btn btn-danger" onclick="return  confirm('Bạn có chắc muốn xóa!')"
                           href="{{route('del_role',$item->id)}}"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>
            @endforeach
