    ...
    <table class="table text-center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class=""><span>{{number_format($user->money,0,'','.')}} <i class="fa-brands fa-bitcoin text-warning"></i></span></td>
                <td class="">
                ...
                <td class=" d-xl-table-cell d-flex justify-content-around text-center">
                    <a href=" {{route('backend_user_detail',['id'=>$user->id,'used_to'=>'detail'])}} " class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                    <a class="btn btn-danger"  onclick="return confirm('Bạn có chắc muốn xóa không')"><i class="fa-solid fa-trash"></i></a>
                </td>
                </td>
            </tr>
            @endforeach
