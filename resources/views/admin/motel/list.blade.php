...
<div class="bg-white shadow-lg p-4 rounded-4">
    <form action="" class="my-4">
        <div class="row">
            <div class="col-3">
                <input class="form-control" name="name" value="{{ $params['name'] ?? '' }}" placeholder="Tìm kiếm theo tên phòng trọ">
            </div>
            <div class="col-2">
            ...
            <div class="col-5">
                ...
                <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-info"><i class="fa-solid fa-file-import"></i> Nhập file exel
                </button>
            </div>
        </div>
    </form>
    <table class="table text-center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="">
                    <a title="Cập nhật phòng trọ" href="{{ route('admin.motel.edit', ['id' => $motel->area_id, 'idMotel' => $motel->id]) }}" class="btn btn-warning">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <form action="{{route('admin.motel.import')}}" method="POST" enctype="multipart/form-data" id="content">
...
<script>
    $("#content").validate({
        ...
        messages: {
            "file": {
                required: "Vui lòng nhập file excel",
            }
        },
