        ...
        <div class="col-6 bg-white p-4 shadow-sm rounded-4">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <select name="actor" id="actor" class="form-control">
                            <option value="">Chọn người thuê nhà</option>
            ...
            <div class="mt-4">
                <div class="row">
                    <div class="col-4">
                        ...
                        <input type="number" name="electric_money" id="electric_money" class="form-control">
                    </div>
                    <div class="col-4">
                        <label for="">Tiền nước</label>
                        <input type="number" name="warter_money" id="warter_money" class="form-control">
                    </div>
                    <div class="col-4">
            ...
            <div class="mt-4">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <input type="number" name="service[toilet]" id="toilet" placeholder="Nhà vệ sinh" class="form-control">
                    </div>
                </div>
            </div>
            <div class="mt-4">
